...
const LoginBox = () => {
    ...
    return (
        <div className="p-8 bg-[#3F3F3F] rounded-3xl text-white w-80 ">
            ...
            <p>
                Are you from a <b>company</b> or are you a solo <b>applicant</b>
                ?
            </p>
            <div className=" ">
                <div className="grid grid-cols-2 grid-row-1 mt-4  ">
                    <button
                        ...
                        className={
                            !clicked
                                ? " mr-5 px-6 py-2.5 bg-blue-600 text-white font-medium text-xs leading-tight uppercase rounded shadow-md hover:bg-blue-700"
                    ...
                    <button
                        ...
                        className={
                            clicked
                                ? " px-6 py-2.5 bg-blue-600 text-white font-medium text-xs leading-tight uppercase rounded shadow-md hover:bg-blue-700"
